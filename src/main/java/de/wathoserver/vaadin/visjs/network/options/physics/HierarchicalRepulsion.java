...
@JsonDeserialize(builder = HierarchicalRepulsion.Builder.class)
public class HierarchicalRepulsion {
  ...
  private HierarchicalRepulsion(Builder builder) {
  ...
  /**
   * Creates builder to build {@link HierarchicalRepulsion}.
   *
  ...
  /**
   * Builder to build {@link HierarchicalRepulsion}.
   */
  public static final class Builder {
    ...
    public HierarchicalRepulsion build() {
      return new HierarchicalRepulsion(this);
    }
  }
